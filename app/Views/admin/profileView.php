...
<div class="row justify-content-center">
    <div class="col-md-3 col-12">
        <div class="row">
            ...
            <div class="col-md-12 col-12">
                <a href="<?= base_url('admin/profile/update_image') ?>" type="button" class="btn btn-primary mr-1 mb-2 w-100" id="btn_image">Ubah Foto Profil</a>
            </div>
        </div>
    </div>
    ...
    saveData = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: window.location.origin + "/admin/profile/update_user",
                    type: "POST",
                    data: {
